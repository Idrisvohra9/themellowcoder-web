...
export default function Profile() {
  ...
  if (!userData) {
    ...
    return (
      <>
        <div className="mainContent profile header__wrapper h-100">
          <header></header>
          <div className="cols__container">
            <div className="left__col">
              ...
              <ul className="about">
                ...
                <li className="c-point">
                  <span>{userData.tmcPoints}</span>TMC points
                </li>
              </ul>
                ...
                {getCookie("username") !== username ? (
                  ...
                  <>
                    ...
                    <div className="dropdown-menu dropdown-menu">
                      <div>
                        <div className="dropdown-item c-point" onClick={logOut}>
                          Log Out
                        </div>
                      </div>
                      <div>
                      ...
                      <div>
                        <Link
                          ...
                          to={`/profile/settings/${userData.username}`}
                        >
                          Profile Settings
                        </Link>
                      </div>
