...
import questions from '../../../questions-medium.json';
import isEmpty from '../../../tools/is-empty.js';
import correctNotification from '../../../static/Other/correct-answer.mp3';
import wrongNotification from '../../../static/Other/wrong-answer.mp3';
import buttonSound from '../../../static/Other/button-sound.mp3';
...
function MyComponentWrapper() {
    ...
    useLoader();
    return <Medium navigate={navigate} />;
  }
...
class Medium extends  Component {
    ...
    endGame = () => {
        ...
        const playerStats = {
            ...
            numberofAnsweredQuestion: state.numberofQuestions - (state.correctAnswers + state.wrongAnswers),
        ...
        setTimeout(() => {
            this.props.navigate('/iqtest/summary',{ state : playerStats});
        }, 1000);
    }
                ...
                <div className="questions">
                    ...
                    <div>
                        <p className="d-flex justify-content-between">
                            ...
                            <span className="right lifeline-icon">{time.minutes}:{time.seconds}<span className="mdi mdi-clock-outline mdi-24px"></span></span>
                        </p>
                    </div>
                    ...
                    <div className="button-container">
                        ...
                        <Link to="/"><button id="quit-button" onClick={this.handleButtonClick}>Quit</button></Link>
                    </div>
                </div>
            </Fragment>
        );
